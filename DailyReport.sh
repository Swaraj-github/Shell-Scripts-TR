...
echo " "
echo -e "${blue}Venus API calls:${NC}"
...
cat /home/asadmin/scripts/temp/venusapioutput | grep "VENUS_ECPDEMODOCKETS" | awk '{print $7 " " $8"/" $17" "$18" " $19}'
cat /home/asadmin/scripts/temp/venusapioutput | grep "ecpdemodockets" | awk '{print $9 " " $10}'
cat /home/asadmin/scripts/temp/venusapioutput | grep "VENUS_ECPDEMOLGLNOV" | awk '{print $7 " " $8"/" $17" "$18" " $19}'
cat /home/asadmin/scripts/temp/venusapioutput | grep "ecpdemolglnov" | awk '{print $9 " " $10}'
...
echo " "
echo -e "${blue}Mercury API calls:${NC}"
...
cat /home/asadmin/scripts/temp/mercuryapioutput | grep "MERCURY_ECPDOCKETS" | awk '{print $7 " " $8"/" $17" "$18" " $19}'
cat /home/asadmin/scripts/temp/mercuryapioutput | grep "ecpdockets" | awk '{print $9 " " $10}'
cat /home/asadmin/scripts/temp/mercuryapioutput | grep "MERCURY_ECPLGLNOV" | awk '{print $7 " " $8"/" $17" "$18" " $19}'
cat /home/asadmin/scripts/temp/mercuryapioutput | grep "ecplglnov" | awk '{print $9 " " $10}'


echo " "
#Neptune API calls
echo " "
echo -e "${blue}Neptune API calls:${NC}"
...
cat /home/asadmin/scripts/temp/neptuneapioutput | grep "NEPTUNE_ECPDOCKETS" |  awk '{print $7 " " $8"/" $17" "$18" " $19}'
cat /home/asadmin/scripts/temp/neptuneapioutput | grep "ecpdockets" | awk '{print $9 " " $10}'
cat /home/asadmin/scripts/temp/neptuneapioutput | grep "NEPTUNE_ECPLGLNOV" | awk '{print $7 " " $8"/" $17" "$18" " $19}'
cat /home/asadmin/scripts/temp/neptuneapioutput | grep "ecplglnov" | awk '{print $9 " " $10}'
